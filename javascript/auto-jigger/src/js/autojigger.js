...
AJ$ = (function () {
	...
	/**
	 * Shorthand access to window.document.head[0]
	 *
	 * @export
	 * @property H$
	 * @type {DOMElement}
	...
	var AutoJigger = {
		 ...
		 *
		 * @method lds
		 * @param {string} $filetype 	either script (js) or link (css)
		 ...
		 */
		vld: function (a) {
			return !(null === a || "undefined" === typeof a || !1 === a || "" === a)
		},
		...
		gex: function (a) {
			...
			else return /(?:\.([^.]+))?$/.exec(a)[1].toLowerCase();
		},
		/**
